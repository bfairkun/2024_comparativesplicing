...
ARHGAP.FlankingIntronicPhyloP %>%
  ...
  Rotate_x_labels +
  labs(x=NULL, y="Nucleotide conservation,\nMean PhyloP", color=NULL)

ggsave("../code/scratch/FinalFigs/OriginalPlots/ARHGAP17_FlankingIntronicConservation.pdf", height=150, width=180, units="mm")
